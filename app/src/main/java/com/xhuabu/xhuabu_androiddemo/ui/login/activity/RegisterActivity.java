...
import com.xhuabu.xhuabu_androiddemo.ui.login.presenter.RegisterPresenter;
...
public class RegisterActivity extends BaseActivity<RegisterPresenter> implements RegisterContract.View {
    ...
    @BindView(R.id.rl_promotionCode)
    RelativeLayout rlPromotionCode;

    @BindView(R.id.et_promotionCode)
    ...
    @OnClick({R.id.rl_code_show, R.id.tv_submit, R.id.tv_login})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.rl_code_show:
                rlCodeShow.setVisibility(View.GONE);
                rlPromotionCode.setVisibility(View.VISIBLE);
                break;
            case R.id.tv_submit:
                ...
                if (TextUtils.isEmpty(userName)) {
                    ...
                    mPresenter.toRegister(userName, passWord, "000000", promotionCode);
                }
